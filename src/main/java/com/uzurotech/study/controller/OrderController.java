...
import com.uzurotech.study.repository.OrderSearch;
import com.uzurotech.study.service.ItemService;
import com.uzurotech.study.service.MemberService;
import com.uzurotech.study.service.OrderService;
...
public class OrderController {
    ...
    public String cancelOrder(@PathVariable("orderId") Long ordreId){
        orderService.cancelOrder(ordreId);
        return "redirect:/orders";
    }
}
